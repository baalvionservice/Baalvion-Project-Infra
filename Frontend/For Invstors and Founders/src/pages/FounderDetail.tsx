                ...
                <div className="space-y-3">
                  {team.map((t) => (
                    <div key={t.id} className="flex items-center gap-3">
                      {t.avatar_url ? <img src={t.avatar_url} alt={t.name} className="w-9 h-9 rounded-full object-cover" /> : <div className="w-9 h-9 rounded-full bg-primary/15 text-primary text-xs font-semibold flex items-center justify-center">{initials(t.name)}</div>}
