...
export default function ClientProjectDetailPage() {
    ...
    const { data: applicationsResponse, isLoading: applicationsLoading, mutate: refreshApplications } = useSWR(projectId ? `ranked-apps-${projectId}` : null, () => rankingService.getRankedApplications(projectId));
