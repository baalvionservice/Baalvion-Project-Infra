...
const nextConfig: NextConfig = {
  ...
  // Replaces the deprecated `experimental.serverComponentsExternalPackages` (renamed + promoted
  // to this top-level stable key in Next 15) and widens the list to the full dynamic-require set.
