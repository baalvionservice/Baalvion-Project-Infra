            ...
            return (
                ...
                <AccordionContent className="border-l-2 border-primary/20 ml-6 pl-10 space-y-8 pt-6 pb-2">
                    <div className="space-y-4">
                        <div className="prose prose-lg max-w-none text-muted-foreground dark:prose-invert" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(round.instructions) }} />
                    </div>
                     <div className="space-y-4">
                        <h4 className="font-semibold flex items-center gap-2 text-primary"><Target className="h-5 w-5" /> Expected Outputs</h4>
                        <div className="prose prose-lg max-w-none text-muted-foreground dark:prose-invert" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(round.expectedOutputs) }} />
                    </div>
    ...
    return (
        <div className="space-y-8">
            <div className="space-y-4">
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground dark:prose-invert" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(task.instructions) }} />
            </div>
            <div className="space-y-4">
                <h3 className="font-semibold flex items-center gap-2 text-xl"><Target className="h-5 w-5 text-primary" /> Expected Outputs</h3>
                <div className="prose prose-lg max-w-none text-muted-foreground dark:prose-invert" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(task.expectedOutputs) }} />
            </div>
        </div>
    );
  }
