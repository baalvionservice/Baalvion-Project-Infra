<!-- Page Six & NY Post Design System for Insurance Details View -->
   ...
   <div class="container-fluid px-lg-5">
      <?php foreach($post_details as $row){ ?>
         <div class="p6-breadcrumb">
            <span class="p6-meta-tag">INSURANCE</span>
            <span>&rsaquo;</span>
            ...
            <div class="d-flex align-items-center gap-3">
               ...
               <div>
                  <div class="d-flex align-items-center flex-wrap gap-2">
                     <strong>Imperialpedia Insurance Desk</strong>
         ...
         <div class="col-lg-8 col-md-12 mb-4">
            <?php foreach($post_details as $row){ ?>
               <?php if(!empty($row['post_img'])){ ?>
                  ...
                  <span class="p6-img-caption mb-4"><i class="fa-solid fa-camera me-1 text-danger"></i> Photo Credit: Imperialpedia Finance Archive &bull; <?php echo !empty($row['post_alt_title']) ? $row['post_alt_title'] : 'Insurance Intelligence Feature'; ?></span>
               <?php } ?>
               ...
               <?php if(!empty($post) && count($post) > 0){ $rec = $post[0]; ?>
                  <div class="p6-see-also-box">
                     ...
                     <a href="<?php echo base_url();foreach($get_subcat_info as $subcat_info){echo 'insurance/'.str_replace(' ','-',$subcat_info['sub_cat_name']);}; echo '/'.str_replace(' ','-',$rec['uri']); ?>" class="p6-see-also-link">
               ...
               <div class="p6-widget-box mt-4 p-4 d-flex align-items-center gap-3 bg-light border-0 shadow-sm" style="border-radius:12px;">
                  ...
                  <div>
                     <h4 class="h6 mb-1 fw-bold text-dark">Written by Imperialpedia Insurance Desk</h4>
                     <p class="small text-muted mb-0">Our financial & insurance research team provides risk data, policy comparisons, and risk management strategies.</p>
                  </div>
               </div>
