...
<!-- Page Six & NY Post Design System for Marketing Master Category View -->
...
/* LIVE MARKET & MARKETING PULSE STRIP */
.p6-market-bar {
  background: #4c1d95;
  color: #e9d5ff;
  font-size: 0.75rem;
...
.p6-search-bar-wrap {
  background: #ffffff;
  border-bottom: 2px solid var(--p6-purple);
  padding: 14px 0;
  margin-bottom: 30px;
}
...
.p6-calc-box {
  background: #ffffff;
  border: 2px solid var(--p6-purple);
  border-radius: 8px;
  padding: 20px;
}
...
.p6-grid-card:hover { transform: translateY(-4px); border-color: var(--p6-purple); }
</style>
      ...
      <div class="row align-items-center">
         <div class="col-lg-8">
            <div class="p6-breadcrumb">
               <span class="p6-meta-tag">MARKETING DESK</span>
               <span>&rsaquo;</span>
               <span>GROWTH &amp; ADS STRATEGY</span>
            </div>
            <h1 class="p6-main-title"><?php echo ucfirst($sc_info['sub_cat_name']); ?></h1>
            <div class="p6-meta-bar mb-3">
               <span>By <strong>Imperialpedia Growth Desk</strong></span>
               <span>&bull;</span>
         ...
         <div class="col-lg-3 col-md-4 mb-4">
            <div class="p6-sticky-col">
               <div class="p6-widget-box">
                  <div class="p6-widget-header border-bottom border-purple border-2 mb-3 pb-2">
                     <h4 class="fw-bold mb-0" style="color:var(--p6-purple)"><i class="fa-solid fa-list-ol me-1"></i> Topic Index</h4>
                  </div>
                  <nav class="p6-toc-list">
                     ...
                     ?>
                              <a href="#<?php echo $slug; ?>" class="d-flex align-items-center p-2 mb-1 rounded text-decoration-none text-dark bg-light p6-mkt-item">
                                 <span class="badge text-white me-2" style="background:var(--p6-purple)"><?php echo sprintf("%02d", $num++); ?></span>
         ...
         <div class="col-lg-3 col-md-12 mb-4">
            <div class="p6-sticky-col">
               ...
               <div class="p6-calc-box mb-4">
                 <span class="badge text-white text-uppercase mb-2" style="background:var(--p6-purple)">INTERACTIVE TOOL</span>
                 <h5 class="fw-bold mb-3 font-serif">📊 Campaign ROI &amp; ROAS Calculator</h5>
                 <div class="mb-3">
                   <label class="form-label small fw-bold text-muted mb-1">AD SPEND: <span id="spendVal" class="text-dark fw-bold">$5,000</span></label>
                   <input type="range" class="form-range" id="spendRange" min="1000" max="50000" step="1000" value="5000" oninput="calcMkt()">
                 </div>
                 <div class="p6-calc-output">
                   <span id="mktResult">$22,500 Revenue (4.5x ROAS)</span>
                 </div>
               </div>

               <div class="p6-widget-box">
                  <div class="p6-widget-header border-bottom border-purple border-2 mb-3 pb-2">
                     <h4 class="fw-bold mb-0" style="color:var(--p6-purple)"><i class="fa-solid fa-bullhorn me-1"></i> Top Growth Guides</h4>
                  </div>
                  <?php $i = 1; foreach($post as $pst1){ ?>
                     <a href="<?php echo base_url().'marketing/'.str_replace(' ','-',$pst1['uri']); ?>" class="d-flex gap-2 text-decoration-none text-dark py-2 border-bottom">
                        <span class="fw-bold fs-5" style="color:var(--p6-purple)">0<?php echo $i++; ?></span>
...
<section class="py-5 bg-white border-top border-purple border-2">
   <div class="container-fluid px-lg-5">
      <h3 class="fw-bold font-serif mb-4">🚀 Imperialpedia Growth &amp; Marketing Blueprints</h3>
      <div class="row g-4">
         <?php foreach($post as $pst){?>
            <div class="col-xl-3 col-lg-4 col-md-6">
               <a href="<?php echo base_url().'marketing/'.str_replace(' ','-',$pst['uri']); ?>" class="p6-grid-card">
                  <div class="p6-grid-body">
                     <span class="badge text-white w-auto me-auto mb-2" style="background:var(--p6-purple)">GROWTH DESK</span>
...
<script>
function filterMkt() {
  var query = document.getElementById('mktSearchInput').value.toLowerCase();
  var items = document.querySelectorAll('.p6-mkt-item');
...
function calcMkt() {
  var spend = document.getElementById('spendRange').value;
  document.getElementById('spendVal').innerText = '$' + Number(spend).toLocaleString();
  var rev = spend * 4.5;
  document.getElementById('mktResult').innerText = '$' + Number(rev).toLocaleString() + ' (4.5x ROAS)';
}
</script>