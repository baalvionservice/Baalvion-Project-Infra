...
<!-- Page Six & NY Post Design System for Online Education Master Category View -->
...
/* LIVE MARKET & EDTECH PULSE STRIP */
.p6-market-bar {
  background: #78350f;
  color: #fef3c7;
  font-size: 0.75rem;
...
.p6-search-bar-wrap {
  background: #ffffff;
  border-bottom: 2px solid var(--p6-amber);
  padding: 14px 0;
  margin-bottom: 30px;
}
...
.p6-grid-card:hover { transform: translateY(-4px); border-color: var(--p6-amber); }
</style>
      ...
      <div class="row align-items-center">
         <div class="col-lg-8">
            <div class="p6-breadcrumb">
               <span class="p6-meta-tag">EDTECH DESK</span>
               <span>&rsaquo;</span>
               <span>ONLINE DEGREES &amp; CERTIFICATIONS</span>
            </div>
            <h1 class="p6-main-title">Online Education in <?php echo ucfirst($pst['sub_cat_name']); ?></h1>
            <div class="p6-meta-bar mb-3">
               <span>By <strong>Imperialpedia EdTech Desk</strong></span>
               <span>&bull;</span>
               <span>Updated <?php echo date('F d, Y'); ?></span>
               <span>&bull;</span>
...
<section class="pb-5">
   <div class="container-fluid px-lg-5">
      <div class="row">
         ...
         <div class="col-lg-3 col-md-4 mb-4">
            <div class="p6-sticky-col">
               <div class="p6-widget-box">
                  <div class="p6-widget-header border-bottom border-warning border-2 mb-3 pb-2">
                     <h4 class="fw-bold mb-0" style="color:var(--p6-amber)"><i class="fa-solid fa-graduation-cap me-1"></i> Program Index</h4>
                  </div>
         ...
         <!-- Center Column: Primary Program Details -->
         <div class="col-lg-6 col-md-8 mb-4">
            <div class="p6-content-box">
               <?php foreach(array_slice($post, 0, 1) as $main_pst){
                  echo insert_ahref_tag($main_pst['post_desc']);
               } ?>
            </div>
         </div>
         ...
         <div class="col-lg-3 col-md-12 mb-4">
            <div class="p6-sticky-col">
               <!-- INTERACTIVE DEGREE ROI ESTIMATOR -->
               <div class="p6-calc-box mb-4">
                 <span class="badge text-white text-uppercase mb-2" style="background:var(--p6-amber)">INTERACTIVE TOOL</span>
                 <h5 class="fw-bold mb-3 font-serif">🎓 Online Degree ROI Calculator</h5>
                 <div class="mb-3">
                   <label class="form-label small fw-bold text-muted mb-1">PROGRAM TUITION: <span id="tuitVal" class="text-dark fw-bold">$12,000</span></label>
                   <input type="range" class="form-range" id="tuitRange" min="3000" max="40000" step="1000" value="12000" oninput="calcEdu()">
                 </div>
                 <div class="p6-calc-output">
                   <span id="eduResult">+$35,000 Salary Lift</span>
                 </div>
               </div>
...
<section class="py-5 bg-white border-top border-warning border-2">
   <div class="container-fluid px-lg-5">
      <h3 class="fw-bold font-serif mb-4">🎓 Imperialpedia EdTech &amp; Degree Programs</h3>
      <div class="row g-4">
         <?php foreach($post as $pst){?>
...
<script>
function filterEdu() {
  var query = document.getElementById('eduSearchInput').value.toLowerCase();
  var items = document.querySelectorAll('.p6-edu-item');
...
function calcEdu() {
  var tuit = document.getElementById('tuitRange').value;
  document.getElementById('tuitVal').innerText = '$' + Number(tuit).toLocaleString();
  var lift = tuit * 2.9;
  document.getElementById('eduResult').innerText = '+$' + Number(Math.round(lift)).toLocaleString() + ' Salary Lift';
}
</script>