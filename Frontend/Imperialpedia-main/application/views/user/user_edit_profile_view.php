   ...
   <div class="row">
      ...
      <div class="col-xxl-4 col-xl-6 mb-4">
         <div class="card card-header-actions h-100">
            ...
            <div class="card-body"> 
                <?php echo form_open('update-profile'); ?>
                <div class="error"><?php if($this->session->msg){ echo $this->session->msg; $this->session->unset_userdata('msg'); }?></div>
                    <div class="mb-3">
                        <label class="small mb-1" for="inputUsername">Full Name </label>
                        <input class="form-control" id="inputUsername username" name="username" type="text" value="<?php echo ucfirst($reg_res['user_name']); ?>">
                    </div>  
                    <div class="row gx-3 mb-3"> 
                        <div class="col-md-6">
                            <label class="small mb-1" for="inputFirstName">Favorate topic</label>
                            <input class="form-control" id="inputFirstName favtopic" name="favtopic" type="text"  value="<?php echo ucfirst($reg_res['user_fav_topic']); ?>">
                        </div> 
                        <div class="col-md-6">
                            <label class="small mb-1" for="inputLastName">Location</label>
                            <input class="form-control" id="inputLastName userlocation" name="userlocation" type="text" placeholder="india" value="<?php echo ucfirst($reg_res['user_location']); ?>">
                        </div>
                    </div>   
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="inputText aboutuser" name="aboutuser" type="text"><?php echo ucfirst($reg_res['user_about']); ?></textarea>
                    </div>  
                    <div class="text-center mt-2 mb-3">
                        <button class="btn btn-bg-teal"type="submit" name="submit"  value="submit">Update</button> 
                    </div>
                </form>         
            </div>
         </div>
