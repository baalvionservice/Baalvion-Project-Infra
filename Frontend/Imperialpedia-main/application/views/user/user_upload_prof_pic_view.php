	...
	transition: .45s
      ...
      <div class="col-xxl-4 col-xl-6 mb-4">
         <div class="card card-header-actions h-100">
            ...
            <div class="card-body"> 
                <?php echo form_open('update-profile-image', array('enctype' => 'multipart/form-data')); ?>
                <div class="error"><?php if($this->session->msg){ echo $this->session->msg; $this->session->unset_userdata('msg'); }?></div> 
                    <div class="mb-3 text-center py-2" style="background: #f7f7f7;"> 
                        <div class=" "> 
                           <div class="md-form">
                           <div class="file-field">
                              <div class="z-depth-1-half mb-4">
                                 <img src="<?php echo base_url().'uploads/user/'.$user_img;?>" class="img-fluid" alt="user profile" height="250" width="250">
                              </div>
                              <div class="d-flex justify-content-center">
                                 <div class="btn btn-primary">
                                 <span>Choose file  <i class="fa-solid fa-upload"></i></span>
                                 <input type="file" name="prof-pic" id="prof-pic">
                                 </div>
                              </div>
                           </div>
                            </div> 
