      ...
      <div class="row">
         <div class="col-lg-9">
            <div class="p6-breadcrumb">
               <span class="p6-meta-tag">INTERNET</span>
               <span>&rsaquo;</span>
               ...
               <div class="d-flex align-items-center gap-3">
                  ...
                  <div>
                     <div class="d-flex align-items-center flex-wrap gap-2">
                        <strong class="text-dark">Imperialpedia Tech Desk</strong>
                     ...
                     <span class="text-muted" style="font-size:0.8rem;"><i class="fa-regular fa-calendar me-1"></i> Posted on <?php echo date('F d, Y', strtotime($row['posted_date'])); ?> &bull; 5 min read</span>
                  </div>
               </div>
               ...
               <div class="p6-widget-box">
                  ...
                  <div class="p6-article-mini-list">
                     <?php $i = 1; foreach($post as $pst1){ if($pst1['post_id'] == $row['post_id']) continue; ?>
                        <a href="<?php echo base_url();foreach($get_subcat_info as $subcat_info){echo 'internet/'.str_replace(' ','-',$subcat_info['sub_cat_name']);}; echo '/'.str_replace(' ','-',$pst1['uri']); ?>" class="p6-article-mini-item">
