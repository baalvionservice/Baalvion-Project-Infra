...
<!-- Page Six & NY Post Design System for Editor Details View -->
               ...
               <div class="d-flex align-items-center gap-3">
                  ...
                  <div>
                     <div class="d-flex align-items-center flex-wrap gap-2">
                        <strong class="text-dark">Imperialpedia Tech & Software Desk</strong>
                     ...
                     <span class="text-muted" style="font-size:0.8rem;"><i class="fa-regular fa-calendar me-1"></i> Posted on <?php echo date('F d, Y', strtotime(!empty($row['updated_date']) ? $row['updated_date'] : $row['posted_date'])); ?> &bull; 5 min read</span>
                  </div>
               </div>
      ...
      <div class="row">
         ...
         <div class="col-lg-6 col-md-8 mb-4">
            ...
            <div class="p6-featured-img-container mb-1">
               <img src="<?php echo base_url().'uploads/post/'.$row['post_img'].'?v=2';?>" 
            ...
            <span class="p6-img-caption mb-4"><i class="fa-solid fa-camera me-1 text-danger"></i> Photo Credit: Imperialpedia Tech Archive &bull; <?php echo !empty($row['post_alt_title']) ? $row['post_alt_title'] : 'Editor Review Feature'; ?></span>
            ...
            <?php if(!empty($post) && count($post) > 0){ $rec = $post[0]; ?>
               <div class="p6-see-also-box">
                  ...
                  <a href="<?php echo base_url();foreach($get_subcat_info as $subcat_info){echo 'editor/'.str_replace(' ','-',$subcat_info['sub_cat_name']);}; echo '/'.str_replace(' ','-',$rec['uri']); ?>" class="p6-see-also-link">
   ...
   <div class="container-fluid px-lg-5">
      <div class="d-flex align-items-center justify-content-between mb-4 pb-2 border-bottom border-2 border-dark">
         <h2 style="font-family: var(--p6-font-headline) !important; font-weight: 800 !important; color: #0f172a !important; letter-spacing: -0.025em; font-size: 1.75rem; font-weight: 700; margin: 0;">
            More Articles in <?php echo str_replace('-',' ',ucfirst($this->uri->segment(2)))?> Editor
         </h2>
