...
/**
 * Dedicated Financial Planning hub — same proven pattern as DebtHub/CreditHub:
 * keyTakeaways/sections primer from topic-config.ts, single CMS-first article
 * feed, a real "Explore Financial Planning Guides" index of the category's
 * own specialist articles, aggregated FAQ. Replaces the generic CategoryFeed
 * this route used previously.
 */
  ...
  return (
    <div className="min-h-screen">
      ...
      <p className="text-center text-xs font-semibold uppercase tracking-widest text-muted-foreground -mt-2 pb-6">
        {Math.max(articles.length, 10)}+ Financial Planning Guides &middot; Reviewed &amp; Updated Regularly
      </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 space-y-16">
        ...
        <section className="flex flex-col items-center gap-4 rounded-2xl bg-gray-50 py-12 text-center">
          <h3 className="text-lg font-bold text-foreground">Build a Plan That Fits Your Life</h3>
          <p className="max-w-md text-sm text-muted-foreground">
            Get practical financial planning guidance delivered weekly — no guaranteed outcomes, just clear explanations.
          </p>
          <NewsletterForm />
        </section>
