...
const SLUG = "financial-independence";

const EXPLORE_MORE = [
  { href: "/investing", label: "Investing" },
  { href: "/planning", label: "Financial Planning" },
  { href: "/retirement", label: "Retirement" },
  { href: "/personal-finance", label: "Personal Finance" },
];

/**
 * Dedicated Financial Independence hub — same proven pattern as
 * DebtHub/CreditHub: keyTakeaways/sections primer from topic-config.ts,
 * single CMS-first article feed, a real "Explore Financial Independence
 * Guides" index of the category's own specialist articles, aggregated FAQ.
 * Replaces the generic CategoryFeed this route used previously.
 */
export async function FinancialIndependenceHub() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <p className="text-center text-xs font-semibold uppercase tracking-widest text-muted-foreground -mt-2 pb-6">
        {Math.max(articles.length, 10)}+ Financial Independence Guides &middot; Reviewed &amp; Updated Regularly
      </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 space-y-16">
        ...
        {gridArticles.length > 0 && (
          <section>
            <h3 className="flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-gray-400 mb-6 pb-2">
              ...
              Explore Financial Independence Guides
            </h3>
        ...
        <section className="flex flex-col items-center gap-4 rounded-2xl bg-gray-50 py-12 text-center">
          <h3 className="text-lg font-bold text-foreground">Plan Your Path to Financial Independence</h3>
          <p className="max-w-md text-sm text-muted-foreground">
            Get practical financial independence guidance delivered weekly — no guaranteed outcomes, just clear explanations.
          </p>
          <NewsletterForm />
        </section>
