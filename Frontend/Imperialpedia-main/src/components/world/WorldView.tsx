...
export default function WorldView({ data }: { data: WorldData }) {
  return (
    <div className="min-h-screen bg-black mt-12 font-sans">
      <script
      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="flex flex-col lg:grid lg:grid-cols-[1fr_280px] gap-px bg-border">
          {/* CENTER — Main content area */}
          <main className="bg-card order-1 min-w-0">
            ...
            <div className="px-2 sm:px-4">
              <div className="flex flex-col md:grid md:grid-cols-[200px_1fr] lg:grid-cols-[240px_1fr] gap-4">
                <aside className="bg-card md:border-l border-border order-2 md:order-1 min-w-0">
          ...
          <aside className="bg-card lg:border-l border-border order-2 hidden lg:block">
            <LatestNews latest={data.latest} />
          </aside>
        </div>

        {/* Latest News — mobile + iPad (below the fold, full width) */}
        <div className="lg:hidden bg-card border-t-2 border-border">
          <LatestNews latest={data.latest} />
        </div>
      </div>
    </div>
