...
export default function QuoteFinderMovers({ watchlist }: { watchlist: WorldData["watchlist"] }) {
  ...
  return (
    <div className="bg-card border-b border-border">
      {/* Quote Finder */}
      <div className="p-3">
        <span className="world-kicker text-[10px] font-black tracking-widest text-foreground uppercase block mb-2">
          Quote Finder
        </span>
        ...
        {query && (
          <div className="mt-2 divide-y divide-border max-h-40 overflow-y-auto">
            {filtered.length === 0 ? (
