            ...
            <div className="relative aspect-video rounded-sm overflow-hidden bg-muted">
              ...
              <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                <span className="w-9 h-9 rounded-full bg-[#fcb700]/95 flex items-center justify-center">
                  <span className="w-0 h-0 border-y-[6px] border-y-transparent border-l-[10px] border-l-black ml-0.5" />
                </span>
              </div>
            </div>
            <p className="text-xs font-semibold leading-snug text-foreground mt-1.5 line-clamp-2">
              {item.headline}
            </p>
          </div>
        ))}
