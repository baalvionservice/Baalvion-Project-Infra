import { BondsHub } from "@/components/pages/BondsHub";
...
// Flagship Bonds pillar (promoted from the generic CategoryFeed hub — see
// topic-config.ts's `bonds` entry for the pillar content). Content is CMS
