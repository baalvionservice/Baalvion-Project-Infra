import { CdRatesHub } from "@/components/pages/CdRatesHub";
...
// Flagship CD Rates pillar (promoted from the generic CategoryFeed hub — see
// topic-config.ts's `cd-rates` entry for the pillar content). Content is CMS
