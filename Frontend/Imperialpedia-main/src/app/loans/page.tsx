import { LoansHub } from "@/components/pages/LoansHub";
...
// Flagship Loans pillar (promoted from the generic CategoryFeed hub — see
// topic-config.ts's `loans` entry for the pillar content). Content is CMS
