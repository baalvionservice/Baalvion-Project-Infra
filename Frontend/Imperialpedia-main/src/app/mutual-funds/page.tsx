import { MutualFundsHub } from "@/components/pages/MutualFundsHub";
...
// Flagship Mutual Funds pillar (promoted from the generic CategoryFeed hub —
// see topic-config.ts's `mutual-funds` entry for the pillar content). Content
// is CMS articles only (verified: no import of marketsLoader/worldFeed/live-
// quote data anywhere in this page's component tree), so there's no live-
// ticker freshness need. ISR instead of force-dynamic: /api/revalidate
