import { CommoditiesHub } from "@/components/pages/CommoditiesHub";
...
// Flagship Commodities pillar (promoted from the generic CategoryFeed hub —
// see topic-config.ts's `commodities` entry for the pillar content). Content
