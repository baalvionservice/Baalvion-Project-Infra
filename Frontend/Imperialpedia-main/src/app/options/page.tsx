import { OptionsHub } from "@/components/pages/OptionsHub";
...
// Flagship Options pillar (promoted from the generic CategoryFeed hub — see
// topic-config.ts's `options` entry for the pillar content). Content is CMS
