import { SavingsHub } from "@/components/pages/SavingsHub";
...
// Flagship Savings pillar (promoted from the generic CategoryFeed hub — see
// topic-config.ts's `savings` entry for the pillar content). Content is CMS
