import { ETFsHub } from "@/components/pages/ETFsHub";
...
// Flagship ETFs pillar (promoted from the generic CategoryFeed hub — see
// topic-config.ts's `etfs` entry for the pillar content). Content is CMS
