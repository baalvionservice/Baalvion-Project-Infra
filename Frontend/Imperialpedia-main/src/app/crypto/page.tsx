import { CryptoHub } from "@/components/pages/CryptoHub";
...
// Flagship Crypto pillar (promoted from the generic CategoryFeed hub — see
// topic-config.ts's `crypto` entry for the pillar content). Content is CMS
