import { CreditHub } from "@/components/pages/CreditHub";
...
// Flagship Credit/Debt pillar (promoted from the generic CategoryFeed hub —
// see topic-config.ts's `credit` entry for the pillar content). Content is
// CMS articles only (verified: no import of marketsLoader/worldFeed/live-quote
