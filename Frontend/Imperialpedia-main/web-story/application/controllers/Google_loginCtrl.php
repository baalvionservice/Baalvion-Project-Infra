...
class Google_loginCtrl extends CI_Controller{
 ...
 function login(){
  ...
  $google_client->setClientId('338182428376-rn5et4in29r4s5836phlvnil6935ufet.apps.googleusercontent.com'); //Define your ClientID
  $google_client->setClientSecret('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'); //Define your Client Secret Key
