...
<section style="background-color: #000;height: 20vw;">
   <div class="text-center sub-text h1"><?php echo ucwords(str_replace('-',' ',$this->uri->segment(2)))?></div>
</section>
<!-- body text sections  -->
<div class="container-fluid my-4 pivacy">
   <div class="row sm-flex-dir-rev">
         ...
         <div class="main-nav float-nav mt-5">
            <ul class="all-top my-2 pl-2 text-center">
               <ul class="half-top my-2">
                  <div class="py-2 widget-title sidebar-head">Do You Know About ?</div>
         ...
         <div class="container my-5">
            ...
            <div class="row center-slide">
               ...
               <div class="col-md-3 col-6 p-1">
                  <a href="<?php echo base_url();foreach($get_subcat_info as $subcat_info){echo 'internet/'.str_replace(' ','-',$subcat_info['sub_cat_name']);}; echo '/'.str_replace(' ','-',$pst['uri']); ?>">
                     <div class="card p-0 cust-cd m-1">
                        ...
                        <div class="card-body">
                           <!-- <a href="#" class="hash-tag"><?php echo '#'.ucfirst($this->uri->segment(2)).' '.ucfirst($this->uri->segment(1));?></a> -->
                           <h5 class="card-title"><a class="text-light" href="<?php echo base_url();foreach($get_subcat_info as $subcat_info){echo 'internet/'.str_replace(' ','-',$subcat_info['sub_cat_name']);}; echo '/'.str_replace(' ','-',$pst['uri']); ?>"><?php echo strtoupper($pst['post_title']);?></a></h5>
                           <div class="ml-3 bottom-cd"><span class="posted-dt text-uppercase"> 
                              <?php $compile = strtotime($pst['posted_date']);echo $myformat1 = date('F d, Y', $compile); ?>
