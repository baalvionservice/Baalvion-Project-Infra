         ...
         <div class="card card-header-actions h-100">
            ...
            <div class="card-body"> 
                ...
                <div class="error"><?php if($this->session->msg){ echo $this->session->msg; $this->session->unset_userdata('msg'); }?></div>       
                    ...
                    <div class="mb-3">
                        <label class="small mb-1" for="inputUsername">Old Password/Temp Password </label>
                        <input class="form-control" id="inputUsername opass" name="opass" type="Password" >
                    </div> <br>
                    <div class="mb-3">
                        <label class="small mb-1" for="inputUsername">New Password </label>
                        <input class="form-control" id="inputUsername pass" name="pass" type="Password" >
                    </div> 
                    <div class="mb-3">
                        <label class="small mb-1" for="inputUsername">Confirm Password </label>
                        <input class="form-control" id="inputUsername cpass" name="cpass" type="Password" >
                    </div> 
