...
<section style="background-color: #000;height: 20vw;">
   <h1 class="text-center sub-text">Editorial Policy</h1>
</section>
<!-- body text sections  -->
<div class="container my-4 pivacy">
   ...
   <p>For over 1 years, we’ve helped hundreds of people do just that. We feel it’s important to share how we go about writing all of the articles that you depend on.</p>
   <h3>Principles</h3>
