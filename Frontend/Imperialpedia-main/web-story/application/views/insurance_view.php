...
<div class="container mt-3 mb-5">
   <div class="row">
      <div class="col-md-8 col-12 cont-sec"> 
         <?php foreach($get_subcat_info as $subcat_info){echo $subcat_info['sub_cat_desc'];};?>
         <!-- container sections  --> 
      </div>
               ...
               <div class="col-md-3 col-6 p-1">
                  <a href="<?php echo base_url();foreach($get_subcat_info as $subcat_info){echo 'insurance/'.str_replace(' ','-',$subcat_info['sub_cat_name']);}; echo '/'.str_replace(' ','-',$pst['uri']); ?>">
                     <div class="card p-0 cust-cd m-1">
                        ...
                        <div class="card-body">
                           <span class="hash-tag"><?php echo ucfirst($this->uri->segment(2)).' '.ucfirst($this->uri->segment(1));?></span>
                           <h5 class="card-title"><a class="text-light" href="<?php echo base_url();foreach($get_subcat_info as $subcat_info){echo 'insurance/'.str_replace(' ','-',$subcat_info['sub_cat_name']);}; echo '/'.str_replace(' ','-',$pst['uri']); ?>"><?php echo strtoupper($pst['post_title']);?></a></h5>
