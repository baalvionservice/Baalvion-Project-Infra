// Supabase-compatible adapter for the self-hosted Baalvion Elite Circle backend
// (Node.js + PostgreSQL, see Backend/elite-circle-service).
//
...
const API_BASE: string =
  (import.meta as any).env?.VITE_API_URL || "https://api.baalvion.com/api/v1/ecosystem/elite-circle/v1";
