    ...
    <footer className="bg-primary text-primary-foreground py-16 border-t border-white/5 overflow-hidden">
      <div className="container px-4 md:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          {/* Contact & Support */}
          <div className="space-y-6">
            <h4 className="font-bold text-white uppercase text-xs tracking-widest border-b border-white/10 pb-4">Contact</h4>
            <div className="space-y-4 text-primary-foreground/60 text-sm">
              ...
              <ul className="space-y-2 pt-4 border-t border-white/5 text-xs font-bold uppercase tracking-tighter opacity-60">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[10px] uppercase font-bold tracking-widest text-primary-foreground/40">
            © 2026 Baalvion Mining Inc. All rights reserved.
          </p>
          <div className="flex gap-6 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all">
            <span className="text-[10px] font-black italic tracking-tighter uppercase">Trade Secure</span>
            <span className="text-[10px] font-black italic tracking-tighter uppercase">Verified Network</span>
            <span className="text-[10px] font-black italic tracking-tighter uppercase">ISO Certified</span>
          </div>
        </div>
      </div>
    </footer>
