    ...
    <main className="flex-1 pt-40 pb-24">
      <div className="section-container max-w-5xl">
        ...
        <section className="mb-24">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Request architecture</h2>
          <p className="text-gray-500 mb-10 max-w-2xl">
            The browser talks to a single origin. Every trade and finance call is proxied through the
            central auth-gateway with signed identity and tenant headers — this app never holds a bearer
            token in JavaScript.
          </p>
