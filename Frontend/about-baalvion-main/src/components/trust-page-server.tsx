    ...
    <main className="pt-32 sm:pt-40 lg:pt-56 pb-24 sm:pb-32 lg:pb-48">
      <div className="section-container">
        <div className="max-w-5xl mb-24 sm:mb-32 lg:mb-48 animate-fade-in">
          ...
          <h1 className="text-gray-900 mb-8 sm:mb-12 font-bold leading-tight text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
            Built on <br />
            Unwavering <span className="text-primary">Trust</span>
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-600 max-w-4xl leading-relaxed font-medium">
            Security, transparency, and international law are at the core of the
            Baalvion Operating System (BOS) infrastructure. We architect for the
        ...
        <div className="grid lg:grid-cols-2 gap-16 sm:gap-24 lg:gap-32 items-center">
          <div className="space-y-12 sm:space-y-16">
            <div className="space-y-4 sm:space-y-6">
              ...
              <h2 className="text-gray-900 font-bold text-2xl sm:text-3xl lg:text-4xl">
                Adhering to the world's strictest protocols.
              </h2>
            </div>
            <div className="grid gap-4 sm:gap-6">
              {badges.map((item, i) => (
                ...
                >
                  ...
                  <span className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-gray-900 tracking-tight">
                    {item}
                  </span>
                </div>
              ))}
          ...
          <div className="bg-primary/[0.03] p-8 sm:p-12 md:p-16 lg:p-24 rounded-2xl sm:rounded-3xl lg:rounded-[3rem] border border-primary/10 text-center space-y-8 sm:space-y-12">
            ...
            <p className="text-base sm:text-lg lg:text-xl mx-auto text-gray-600 font-medium">
              Request our complete security whitepaper and compliance
              certificates for your strategic audit and due diligence process.
            </p>
