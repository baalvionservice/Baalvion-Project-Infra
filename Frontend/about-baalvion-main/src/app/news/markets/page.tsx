...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://about.baalvion.com/api/og?title=Baalvion+International+Markets+News&eyebrow=Baalvion+News", width: 1200, height: 630, alt: "Baalvion International Markets News" }],
    locale: "en_US",
    type: "website",
  },
  twitter: {
    ...
    title: "International Markets | Baalvion News",
    description: "Global expansion, international trade routes, and market growth news from Baalvion Industries.",
    images: ["https://about.baalvion.com/api/og?title=Baalvion+International+Markets+News&eyebrow=Baalvion+News"],
  },
};
