...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://about.baalvion.com/api/og?title=Baalvion+Sustainability+%26+ESG+News&eyebrow=Baalvion+News", width: 1200, height: 630, alt: "Baalvion Sustainability & ESG News" }],
    locale: "en_US",
    type: "website",
  },
  twitter: {
    ...
    title: "Sustainability & ESG | Baalvion News",
    description: "Green initiatives, ESG reports, and sustainability governance news from Baalvion Industries.",
    images: ["https://about.baalvion.com/api/og?title=Baalvion+Sustainability+%26+ESG+News&eyebrow=Baalvion+News"],
  },
};
