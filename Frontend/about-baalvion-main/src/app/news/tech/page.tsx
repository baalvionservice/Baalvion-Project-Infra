...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://picsum.photos/seed/baalvion-news-tech/1200/630", width: 1200, height: 630, alt: "Baalvion Technology & AI News" }],
    locale: "en_US",
    type: "website",
  },
  twitter: {
    ...
    title: "Technology & AI | Baalvion News",
    description: "Platform updates, AI scoring advancements, and technology innovation news from Baalvion Industries.",
    images: ["https://picsum.photos/seed/baalvion-news-tech/1200/630"],
  },
};
