...
export default async function EntertainmentHubPage() {
  ...
  // Next tier down, same real view counts -- the second sidebar widget
  // (Most Read and Trending Now are deliberately two separately ranked
  // boxes, not the same five twice).
