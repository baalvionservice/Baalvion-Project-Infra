...
// Root error boundary. Replaces the document, so it renders its own html/body
// and cannot assume the stylesheet loaded — same self-contained treatment as
// error.tsx, inlined.
export default function GlobalError({
  ...
  useEffect(() => {
    console.error('[Law-Elite-Network-main] Unhandled application error:', error);
  }, [error]);
