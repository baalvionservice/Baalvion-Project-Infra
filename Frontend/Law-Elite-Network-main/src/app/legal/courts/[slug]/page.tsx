...
import { getMergedCourtBySlug, getMergedCourts, getMergedCasesForCourt, getLatestNewsForCourt } from '@/lib/legal-server';

export const revalidate = 86400;

export async function generateStaticParams() {
  return (await getMergedCourts()).map((c) => ({ slug: c.slug }));
}
