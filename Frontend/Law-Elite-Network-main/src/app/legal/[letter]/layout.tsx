...
/** Count bundled articles for this letter — drives the noindex-when-empty rule. */
function bundledCount(letter: string): number {
  return getAllArticles().filter((a) => a.alphabet === letter).length;
}
