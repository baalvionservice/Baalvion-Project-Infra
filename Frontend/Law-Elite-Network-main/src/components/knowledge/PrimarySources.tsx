 ...
 * always visible (not collapsed -- the point is to show real citations
 * before the reader gets to the claims they back, matching the "Sources"
 * placement the site put right after the disclaimer). Categorized via
 * `classifySources()` into the buckets legal-YMYL readers expect. Only
 * renders entries the article data actually carries; see the
