...
// see the 'consent-default' script in layout.tsx, which denies everything until
// this banner updates it). Required by Google's EU User Consent Policy for any
// AdSense publisher with EEA/UK traffic; applied to every visitor rather than
// geo-detecting, since under/over-detecting EEA visitors is worse than asking once.
// The privacy policy (src/app/privacy-policy/page.tsx) explicitly promises this banner.
    ...
    >
      <div className="mx-auto flex max-w-6xl flex-col gap-3 px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-sm text-slate-600">
          ...
          and{" "}
          <Link href="/privacy-policy" className="underline underline-offset-2 hover:text-blue-700">
            Privacy Policy
          </Link>
          .
        </p>
