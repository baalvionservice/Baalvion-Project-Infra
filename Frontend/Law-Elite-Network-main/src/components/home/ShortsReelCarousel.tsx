...
const SHORTS_DATA: ShortItem[] = [
  ...
  {
    id: 'short-2',
    title: 'Page Six Spotted: Defense Counsel Reacts to Surprise Evidence Ruling',
    personName: 'Page Six Legal Desk',
    views: '840K',
    duration: '0:42',
    thumbnail: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=600&q=80',
    category: 'Page Six Exclusive',
    verifiedBadge: true,
  },
  {
    id: 'short-3',
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2 text-xs text-red-500 font-black uppercase tracking-widest">
              <span>PAGE SIX & LAW ELITE REELS</span>
              <span>•</span>
