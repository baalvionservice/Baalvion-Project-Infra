...
/**
 * Curated photo galleries for Law Elite court cameras & red carpet media.
...
export const PHOTO_GALLERIES: PhotoGallery[] = [
  ...
  {
    slug: 'law-elite-spotted-celebrity-legal-desk',
    title: 'Law Elite Spotted: Red Carpet & Legal Desk Sightings',
    description:
