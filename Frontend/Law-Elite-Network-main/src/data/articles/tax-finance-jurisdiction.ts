...
export const taxFinanceJurisdictionArticles: LawArticle[] = [
  {
    ...
    primarySources: [
      { label: 'Internal Revenue Code § 121 — exclusion of gain from sale of principal residence (Cornell Legal Information Institute)', url: 'https://www.law.cornell.edu/uscode/text/26/121' },
      { label: 'IRS Publication 523, Selling Your Home', url: 'https://www.irs.gov/publications/p523' },
      { label: 'H.R. 4327, No Tax on Home Sales Act, 119th Congress (introduced, not enacted)', url: 'https://www.congress.gov/bill/119th-congress/house-bill/4327' },
    ],
...
<p><em>This article is general legal information, not legal or tax advice. Federal tax law changes over time, and state-level tax treatment of home sales varies separately — consult a tax professional before acting.</em></p>`,
  },
  {
    ...
    primarySources: [
      { label: 'Taxation of Chargeable Gains Act 1992, sections 222–223 (Private Residence Relief)', url: 'https://www.legislation.gov.uk/ukpga/1992/12/section/222' },
      { label: 'HMRC, HS283 Private Residence Relief helpsheet', url: 'https://www.gov.uk/government/publications/private-residence-relief-hs283-self-assessment-helpsheet' },
      { label: 'GOV.UK, report and pay Capital Gains Tax on UK property within 60 days', url: 'https://www.gov.uk/guidance/capital-gains-tax-for-non-residents-uk-residential-property' },
    ],
...
<p><em>This article is general legal information, not legal or tax advice, and covers the position in the UK generally understood to apply where the property is in England — Scotland and Wales share the same UK-wide Capital Gains Tax rules but have their own separate property transaction taxes. Consult a tax adviser before acting.</em></p>`,
  },
  {
    ...
    country: 'Canada',
    primarySources: [
      { label: 'Income Tax Act (Canada), sections 40(2)(b) and 54 — principal residence definition and exemption formula', url: 'https://laws-lois.justice.gc.ca/eng/acts/i-3.3/section-54.html' },
      { label: 'Canada Revenue Agency, Income Tax Folio S1-F3-C2, Principal Residence', url: 'https://www.canada.ca/en/revenue-agency/services/tax/technical-information/income-tax/income-tax-folios-index/series-1-individuals/folio-3-family-unit-issues/income-tax-folio-s1-f3-c2-principal-residence.html' },
    ],
...
<p><em>This article is general legal information, not legal or tax advice. Canadian tax law changes over time and provincial rules can add further considerations — consult a tax professional licensed in Canada before acting.</em></p>`,
  },
  {
    ...
    country: 'Australia',
    primarySources: [
      { label: 'Income Tax Assessment Act 1997 (Cth), Subdivision 118-B — main residence exemption', url: 'https://www.austlii.edu.au/cgi-bin/viewdoc/au/legis/cth/consol_act/itaa1997240/s118.100.html' },
      { label: 'Australian Taxation Office, "Eligibility for main residence exemption"', url: 'https://www.ato.gov.au/individuals-and-families/investments-and-assets/capital-gains-tax/property-and-capital-gains-tax/your-main-residence-home/eligibility-for-main-residence-exemption' },
      { label: 'Australian Taxation Office, "Main residence exemption for foreign residents"', url: 'https://www.ato.gov.au/individuals-and-families/investments-and-assets/capital-gains-tax/foreign-residents-and-capital-gains-tax/main-residence-exemption-for-foreign-residents' },
      { label: 'Parliament of Australia, Bills Digest: Treasury Laws Amendment (Tax Reform No.1) Bill 2026', url: 'https://www.aph.gov.au/Parliamentary_Business/Bills_Legislation/bd/bd2526/26bd067' },
      { label: 'Treasury Laws Amendment (Tax Reform No. 1) Act 2026 — second reading speech', url: 'https://ministers.treasury.gov.au/ministers/jim-chalmers-2022/speeches/second-reading-speech-treasury-laws-amendment-tax-reform-no-1' },
    ],
    content: `<p>Australia's capital gains tax treatment of a home sale rests on two genuinely separate mechanisms that are easy to conflate: a <strong>main residence exemption</strong> that can eliminate CGT on your home entirely, and a general <strong>50% CGT discount</strong> that applies more broadly to assets held over 12 months. Most people who sell a straightforward family home never need to think about the discount at all, because the exemption already covers the whole gain — but the distinction matters for anyone whose home wasn't fully exempt, and a reform enacted in mid-2026 is about to change how the discount half of that equation works once it takes effect from 1 July 2027.</p>

<div class="key-takeaways"><h4>Key Takeaways</h4><ul><li>A dwelling can be fully exempt from CGT under the main residence exemption if it was your home for your whole ownership period, wasn't used to produce income, and sits on 2 hectares of land or less.</li><li>Foreign residents at the time of sale generally cannot claim the main residence exemption, a rule that started on 9 May 2017 (with a transition for older properties sold by 30 June 2020) and narrowly allows a &ldquo;life events&rdquo; exception; it catches many Australians who move overseas before selling.</li><li>The "6-year rule" lets you keep treating a former home as your main residence for up to 6 years after moving out, if you rent it out in the meantime (indefinitely if you don't).</li><li>The separate 50% CGT discount applies to the taxable, non-exempt portion of a gain on assets (including property) held 12 months or more — it is a different mechanism from the main residence exemption and can apply alongside it.</li><li>The Treasury Laws Amendment (Tax Reform No. 1) Act 2026 received Royal Assent on 26 June 2026 and, from 1 July 2027, replaces the 50% discount for individuals and trusts (and partnerships) with cost-base indexation plus a 30% minimum tax on capital gains accruing from that date; gains that accrued before 1 July 2027 keep the 50% discount even if the asset is sold later.</li></ul></div>

<h2>The Main Residence Exemption</h2>
<p>Under Subdivision 118-B of the Income Tax Assessment Act 1997, a dwelling is generally fully exempt from CGT if it was your home for the whole period you owned it, you didn't use it to produce assessable income (such as rent), and the land it sits on is 2 hectares or less. A significant, often-missed limitation applies to Australians living abroad: since 7:30pm AEST on 9 May 2017, foreign residents at the time of the sale generally cannot claim the main residence exemption at all, even if the home was genuinely their main residence for the entire period they owned it while living in Australia. A transitional rule preserved the exemption for properties acquired before that time and sold on or before 30 June 2020. Since then, a foreign resident can claim the exemption only if a &ldquo;life events&rdquo; test is met: broadly, the continuous period of foreign residency is six years or less and there has been a terminal medical condition affecting you, your spouse or a child under 18, the death of your spouse or a child under 18, or a relationship breakdown (see section 118-110 of the ITAA 1997 and the ATO&rsquo;s guidance). Outside that exception a foreign resident at the time of sale generally has no main residence exemption, which is a real trap for Australians who relocate overseas before listing their former home.</p>
...
<p>Following the 2026-27 Federal Budget, the government introduced the Treasury Laws Amendment (Tax Reform No. 1) Bill 2026 into Parliament on 28 May 2026, and it received Royal Assent as the Treasury Laws Amendment (Tax Reform No. 1) Act 2026 on 26 June 2026 — it is now enacted law, though most of its substantive changes are not yet in effect. Once effective, it replaces the 50% CGT discount for individuals and trusts with a system of cost-base indexation (adjusting the original purchase cost for inflation before calculating the taxable gain) combined with a 30% minimum tax rate on net capital gains — but only for gains accruing from 1 July 2027 onward. For an asset held before that date and sold afterwards, the 50% discount is reported to apply to the gain accrued up to 1 July 2027, with the asset&rsquo;s market value at that date forming the starting point for the new system; the Act&rsquo;s own valuation and apportionment rules should be checked. And individuals and trusts disposing of new residential dwellings or affordable housing on or after 1 July 2027 will be able to choose between the old discount and the new indexation-based regime. It's worth being precise about what this reform does and doesn't touch: it changes how the <em>discount</em> is calculated for the taxable portion of a gain — it does not remove or narrow the main residence exemption itself, which remains a separate mechanism. As of this writing, consultation continues on how the new regime interacts with small business concessions, and further amending legislation is possible before 1 July 2027.</p>

<h2>Frequently Asked Questions</h2>
<h3>If I've lived overseas for years, will I owe Australian CGT when I sell my old family home?</h3>
<p>Very possibly yes, and this surprises many people. Since 9 May 2017 (with a transition for older properties sold by 30 June 2020), foreign residents at the time of sale generally cannot claim the main residence exemption, even for years the property genuinely was their home while they lived in Australia, unless the narrow life events test is met — get specific advice before assuming your old home sale will be exempt.</p>
