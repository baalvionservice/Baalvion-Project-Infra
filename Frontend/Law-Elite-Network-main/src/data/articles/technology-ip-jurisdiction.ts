...
<p>If your organization handles personal data connected to both the UK and the EU, treat this as two related but separately maintained compliance programs rather than one — confirm which specific UK reforms (recognised legitimate interests, the new automated-decision-making rules, the cookie exemptions, the new transfer test) actually apply to what you do, since several took effect only in early 2026. Check the ICO's current guidance directly given the regulator itself is mid-transition, and revisit your EU and UK representative and transfer-mechanism arrangements to make sure both sides are actually covered rather than assuming one filing covers both. For the general, worldwide picture of how modern data privacy law works, see <a href="/article/data-privacy-law-basics">Data Privacy Law Basics: How Personal Data Is Protected</a>.</p>
...
<p><em>This article is general legal information, not legal advice. UK and EU data protection law is changing rapidly — confirm the current position with the Information Commissioner's Office or the European Data Protection Board, and consult a qualified data protection lawyer for advice on your specific situation.</em></p>`,
    primarySources: [
      ...
      { label: 'The Data (Use and Access) Act 2025 (Commencement No. 6 and Transitional and Saving Provisions) Regulations 2026', url: 'https://www.legislation.gov.uk/uksi/2026/82/regulation/2/made' },
