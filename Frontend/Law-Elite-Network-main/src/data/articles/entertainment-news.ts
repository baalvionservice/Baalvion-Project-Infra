...
export const entertainmentNewsArticles: LawArticle[] = [
  ...
  {
    id: 'ent-celeb-001',
    title: 'Law Elite Legal Analysis: Defamation, Right of Publicity & Celebrity Paparazzi Litigation',
    slug: 'law-elite-legal-analysis-defamation-right-of-publicity-paparazzi-litigation',
    alphabet: 'P',
