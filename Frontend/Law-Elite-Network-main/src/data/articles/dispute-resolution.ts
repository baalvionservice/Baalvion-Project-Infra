...
<p>Both institutions administer proceedings under the same broad international framework — the tribunal exercises kompetenz-kompetenz to rule on its own jurisdiction (LCIA Article 23; ICC Article 6(3)-(9)), and a resulting award is enforceable in over 160 states under the 1958 New York Convention. Where they diverge is in the operational detail that actually shapes cost, timeline, and control over the proceeding. For a full walkthrough of the LCIA process specifically, from filing to award, see <a href="/article/lcia-international-arbitration-london-practitioner-guide">The Comprehensive Practitioner's Guide to LCIA International Arbitration in London</a>.</p>

<h3>How are arbitrator and institutional fees calculated?</h3>
<ul>
<li><strong>LCIA:</strong> Arbitrators and the LCIA Secretariat bill by the hour against published rate caps in the <a href="/article/lcia-arbitration-costs-administrative-fees-calculated">LCIA Schedule of Costs</a>, plus a fixed, non-refundable registration fee payable on filing. Cost is therefore a function of how contested and how long the case runs, not the sum in dispute.</li>
