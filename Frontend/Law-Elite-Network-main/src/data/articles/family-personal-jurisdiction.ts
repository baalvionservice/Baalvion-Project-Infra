...
export const familyPersonalJurisdictionArticles: LawArticle[] = [
  {
    id: 'fp-301',
    title: 'Community Property vs. Equitable Distribution in the U.S.',
    ...
    primarySources: [
      { label: '26 U.S.C. § 1014(b)(6) — community property basis step-up on death (Cornell Legal Information Institute)', url: 'https://www.law.cornell.edu/uscode/text/26/1014' },
      { label: 'New York Domestic Relations Law § 236(B)(5)(d) — equitable distribution factors', url: 'https://www.nysenate.gov/legislation/laws/DOM/236' },
    ],
...
<ul>
<li><strong>California, Louisiana, New Mexico, Idaho, Nevada, and Wisconsin</strong> start from an equal or substantially equal division of the community estate. California's Family Code, for example, generally directs the court to divide the community estate equally. Idaho calls for a "substantially equal" division unless there are compelling reasons otherwise; Nevada directs an equal disposition "to the extent practicable," with an unequal one allowed only for a compelling reason stated in writing (such as one spouse having wasted or hidden marital assets); and Wisconsin presumes that marital property is divided equally, with departures only after weighing statutory factors.</li>
<li><strong>Texas, Arizona, and Washington</strong>, despite also being community property states, give their courts real discretion to divide the community estate <em>unequally</em> where fairness calls for it. Texas law directs courts to divide the marital estate in a manner the court deems "just and right," which is not the same promise as an even split — Texas courts can order splits that favor one spouse, based on factors like fault, earning capacity, or who will have primary custody of the children. Arizona's statute was amended decades ago to replace "equal" with "equitable" language for the same reason.</li>
</ul>
...
<p>Not necessarily. Whether your state requires a strict equal split of community property, or gives courts discretion to divide it unequally, depends on which community property state you're in — California, Louisiana, New Mexico, Idaho, Nevada, and Wisconsin start from an equal or substantially equal division, while Texas, Arizona, and Washington allow unequal divisions based on fairness factors.</p>
...
<ul>
<li>Cal. Fam. Code §2550; Tex. Fam. Code §7.001; Ariz. Rev. Stat. §25-318; Wash. Rev. Code §26.09.080; Nev. Rev. Stat. §125.150; N.M. Stat. §40-3-8; Idaho Code §32-712; Wis. Stat. §767.61 (community property division standards by state)</li>
...
<p><em>This article is general legal information, not legal advice, and is not a substitute for individualized guidance. Property division law varies by state and changes over time — consult a family lawyer licensed in your state before acting.</em></p>`,
  },
  {
    ...
    primarySources: [
      { label: 'Matrimonial Causes Act 1973, section 25 (as amended)', url: 'https://www.legislation.gov.uk/ukpga/1973/18/section/25' },
      { label: 'White v White [2000] UKHL 54 — "yardstick of equality"', url: 'https://www.bailii.org/uk/cases/UKHL/2000/54.html' },
      { label: 'Radmacher v Granatino [2010] UKSC 42 — weight given to nuptial agreements', url: 'https://www.bailii.org/uk/cases/UKSC/2010/42.html' },
      { label: 'GOV.UK: A fairer end to relationships (consultation, 5 June to 14 August 2026)', url: 'https://www.gov.uk/government/consultations/a-fairer-end-to-relationships' },
      { label: 'Wyatt v Vince [2015] UKSC 14 — no fixed time limit on a post-divorce financial claim', url: 'https://www.bailii.org/uk/cases/UKSC/2015/14.html' },
    ],
...
<p>The current framework has faced sustained criticism for giving judges very wide discretion without much statutory precision, and reform is genuinely underway — though nothing has changed yet. The Law Commission published a scoping report in December 2024 setting out four possible models for reform, ranging from simply codifying the existing case law to a far more prescriptive statutory formula, without recommending a single option. The government has since indicated it favors a "codification-plus" approach — putting the needs and sharing principles on a statutory footing, alongside targeted changes such as making certain "qualifying" nuptial agreements automatically binding rather than merely persuasive. A public consultation, <strong>"A fairer end to relationships,"</strong> opened on 5 June 2026 and closed on 14 August 2026; it also covers financial provision for cohabitants. This article does not record any final government response or bill, so check for updates. <strong>Anyone relying on this area of law today is still governed by the Matrimonial Causes Act 1973 framework described above — the reform discussion is real, but it is not yet law, and won't be for some time even in the best case.</strong></p>
...
<p>Not yet. A government consultation on reforming this area closed on 14 August 2026, and the government has indicated a preferred direction, but this article does not record any bill or final response. The Matrimonial Causes Act 1973 framework, as shaped by White v White and Miller/McFarlane, remains the current law.</p>
...
<p><em>This article is general legal information about the law of England and Wales, not legal advice, and reflects the law as understood at the time of writing during an active government consultation on reform. Scotland and Northern Ireland have separate family law systems. Consult a solicitor before acting.</em></p>`,
  },
  {
    ...
    country: 'Australia',
    primarySources: [
      { label: 'Family Law Act 1975 (Cth), Parts VIII and VIIIAB, as amended by the Family Law Amendment Act 2024', url: 'https://www.austlii.edu.au/cgi-bin/viewdb/au/legis/cth/consol_act/fla1975114/' },
      { label: 'Stanford v Stanford [2012] HCA 52 — whether a property order is just and equitable', url: 'https://www.austlii.edu.au/cgi-bin/viewdoc/au/cases/cth/HCA/2012/52.html' },
      { label: "Attorney-General's Department, family law changes from June 2025 — information for family law professionals", url: 'https://www.ag.gov.au/families-and-marriage/publications/family-law-changes-june-2025-information-family-law-professionals' },
    ],
