/**
 * @deprecated This mock data file is superseded by live API calls via
 * `@/lib/api-client`. Do not delete — navigation and page definitions
 * are still consumed directly from this file by layout components.
 * Replace individual usages with real API calls as each section is wired up.
 */
import {
  NavigationItem,
  PageDefinition,
