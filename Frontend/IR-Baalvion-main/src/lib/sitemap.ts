...
const STATIC_PUBLIC: Array<{ path: string; changeFrequency: ChangeFreq; priority: number }> = [
  ...
  // Institutional investor pages (high-priority, conversion-focused surfaces).
  { path: '/why-invest', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/investment-thesis', changeFrequency: 'monthly', priority: 0.9 },
  { path: '/market-opportunity', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/use-of-proceeds', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/financials', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/company/story', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/governance/framework', changeFrequency: 'monthly', priority: 0.7 },
