...
module.exports = {
  ...
  jwt: {
    // HS256 shared secret (used by proxy-backend, jobs-service, etc.)
    secret:       process.env.JWT_SECRET            || '',
    // RS256 asymmetric keys (preferred — issued by auth-service)
    publicKey:    process.env.JWT_PUBLIC_KEY      || '',
    publicKeyB64: process.env.JWT_PUBLIC_KEY_B64  || '',
    issuer:       process.env.JWT_ISSUER          || 'baalvion-auth',
    audience:     process.env.JWT_AUDIENCE        || 'baalvion-services',
