...
function getPublicKey() {
    ...
    if (config.jwt.publicKeyPath) {
        ...
        // Fetch from auth-service JWKS in production; for dev fall through
        throw new Error('No JWT public key configured. Set JWT_PUBLIC_KEY_PATH, JWT_PUBLIC_KEY_B64, or JWT_PUBLIC_KEY.');
    }
    return _publicKey;
}
