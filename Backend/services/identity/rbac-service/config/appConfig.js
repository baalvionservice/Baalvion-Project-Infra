...
module.exports = {
    ...
    jwt: {
        // RS256 is the ONLY accepted access-token scheme (R2): verifyAccessToken rejects
        // any non-RS256 alg and production fails closed without an RS256 public key (guard
        // above). `accessSecret` is retained only to satisfy the auth-node adapter API and
        // is never used to verify access tokens — there is no HS256 acceptance path.
