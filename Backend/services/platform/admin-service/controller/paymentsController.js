...
exports.listTransactions = async (req, res, next) => { try { const { page, limit } = pageArgs(req.query); const { items, total } = await pay.listTransactions({ page, limit, provider: req.query.provider, status: req.query.status }); sendPaginated(req, res, items, total, page, limit); } catch (e) { next(e); } };
...
exports.listSubscriptions = async (req, res, next) => { try { const { page, limit } = pageArgs(req.query); const { items, total } = await pay.listSubscriptions({ page, limit, provider: req.query.provider, status: req.query.status }); sendPaginated(req, res, items, total, page, limit); } catch (e) { next(e); } };
...
exports.listInvoices = async (req, res, next) => { try { const { page, limit } = pageArgs(req.query); const { items, total } = await pay.listInvoices({ page, limit, status: req.query.status }); sendPaginated(req, res, items, total, page, limit); } catch (e) { next(e); } };
...
exports.listRefunds = async (req, res, next) => { try { const { page, limit } = pageArgs(req.query); const { items, total } = await pay.listRefunds({ page, limit }); sendPaginated(req, res, items, total, page, limit); } catch (e) { next(e); } };
...
exports.listWebhooks = async (req, res, next) => { try { const { page, limit } = pageArgs(req.query); const { items, total } = await pay.listWebhooks({ page, limit, provider: req.query.provider, status: req.query.status }); sendPaginated(req, res, items, total, page, limit); } catch (e) { next(e); } };
