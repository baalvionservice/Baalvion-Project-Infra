 ...
 * payment-service -> giftcard-service billing-fulfill calls (x-internal-secret header).
 * Mirrors community-service/service/internalSecret.js's contract exactly (constant-time,
