...
const createJobSchema = z.object({
    ...
    country_id: z.string().max(20).optional(),
    department_id: z.string().max(40).optional(),
    ...
    salary_period: z.enum(['year', 'month', 'day', 'hour']).default('year'),
...
const updateJobSchema = z.object({
    ...
    salary_period: z.enum(['year', 'month', 'day', 'hour']).optional(),
