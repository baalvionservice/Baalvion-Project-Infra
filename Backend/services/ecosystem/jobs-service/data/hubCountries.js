...
/**
 * Editorial "hiring hub" countries.
 *
 * These are the countries Baalvion writes about — each has an overview, a compliance
 * profile and (for India) a state list, and each gets its own /careers/countries/<slug>
 * page. They are NOT the set of places you can hire in or apply from: countries.js
 * merges these over the full ISO-3166 list, so every country on earth is postable and
 * applicable, and these nine simply carry extra editorial detail.
 */
module.exports = [
  {
    ...
    isHub: true, isActive: true, displayOrder: 1,
  },
  {
    ...
    isHub: true, isActive: true, displayOrder: 2,
  },
  {
    ...
    isHub: true, isActive: true, displayOrder: 3,
  },
  {
    ...
    isHub: true, isActive: true, displayOrder: 6,
  },
  {
    ...
    isHub: true, isActive: true, displayOrder: 7,
  },
  {
    ...
    isHub: true, isActive: true, displayOrder: 8,
  },
  {
    ...
    isHub: true, isActive: true, displayOrder: 9,
  },
  {
    ...
    isHub: true, isActive: true, displayOrder: 10,
  },
  {
    ...
    isHub: true, isActive: true, displayOrder: 11,
  },
];
