...
import com.baalvion.tradefinance.dto.ErrorResponse;
 ...
 * The correlationId is the request trace id carried in the MDC by the shared
 * {@code CorrelationIdFilter} (common-security).
 */
@Slf4j
