...
CREATE INDEX idx_audit_tenant_event_type ON audit.audit_logs(tenant_id, event_type, created_at DESC);
CREATE INDEX idx_audit_tenant_aggregate ON audit.audit_logs(tenant_id, aggregate_id);
...
CREATE INDEX idx_audit_payload_gin ON audit.audit_logs USING GIN (payload);
