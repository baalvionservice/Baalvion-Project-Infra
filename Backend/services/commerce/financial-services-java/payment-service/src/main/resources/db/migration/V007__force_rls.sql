...
ALTER TABLE payments.transactions FORCE ROW LEVEL SECURITY;
ALTER TABLE payments.outbox_events FORCE ROW LEVEL SECURITY;
ALTER TABLE payments.approval_requests FORCE ROW LEVEL SECURITY;
