...
import com.baalvion.wallet.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleOptimisticLock(Exception ex, HttpServletRequest request) {
    ...
    return build(HttpStatus.CONFLICT, "CONCURRENT_MODIFICATION", "Balance was modified concurrently; retry the request", request);
  }
