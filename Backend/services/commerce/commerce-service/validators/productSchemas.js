...
exports.PRODUCT_CONDITIONS = PRODUCT_CONDITIONS;
const resaleFields = {
    condition: z.enum(PRODUCT_CONDITIONS).optional().nullable(),
    conditionGrade: z.string().max(40).optional().nullable(),
    conditionNotes: z.string().max(5000).optional().nullable(),
    authenticityStatus: z.string().max(40).optional().nullable(),
    authenticityCertificateCode: z.string().max(120).optional().nullable(),
...
exports.moderateProductSchema = z.object({
