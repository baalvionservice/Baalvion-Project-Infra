...
router.patch('/fulfillment/stores/:storeId/shipments/:shipmentId', authMiddleware, validate(updateShipmentSchema), ctrl.updateShipment);
router.post('/fulfillment/stores/:storeId/shipments/:shipmentId/tracking', authMiddleware, validate(addTrackingEventSchema), ctrl.addTrackingEvent);
