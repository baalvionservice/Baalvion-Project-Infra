-- 064 — Additively extends trade.notifications type CHECK (migrations 023, 039) with
-- 'tender_invitation' — used by POST /organizations/:id/invite-to-tender. No existing
-- value removed.
--
