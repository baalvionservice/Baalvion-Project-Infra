...
module.exports = {
    service: process.env.SERVICE_NAME || 'product-registry-service',
    version: '1.0.0',
    env: process.env.NODE_ENV || 'development',
    port: Number(process.env.PORT || 3048),
    schema: process.env.DB_SCHEMA || 'product',
    apiVersion: 'v1',
    ...
    eventBus: {
        ...
        consumerGroup: process.env.EVENT_CONSUMER_GROUP || 'product-registry-service',
    },
