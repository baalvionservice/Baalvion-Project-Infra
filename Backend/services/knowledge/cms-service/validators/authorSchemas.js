...
const createAuthorSchema = z.object({
    ...
    education: z.array(z.string().max(200)).max(10).optional(),
    certifications: z.array(z.string().max(150)).max(15).optional(),
    editorialRole: z.enum(['writer', 'reviewer', 'fact-checker', 'contributor']).optional().nullable(),
    social: socialSchema,
