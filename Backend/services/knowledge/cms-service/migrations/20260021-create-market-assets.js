...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        await queryInterface.bulkInsert({ tableName: 'market_assets', schema: 'cms' }, [
            ...
            row('BTC', 'bitcoin', 'Bitcoin', 'crypto', 'GLOBAL', 'binance', 'CRYPTO', 'Bitcoin', 30),
            row('ETH', 'ethereum', 'Ethereum', 'crypto', 'GLOBAL', 'binance', 'CRYPTO', 'Ethereum', 31),
            row('SOL', 'solana', 'Solana', 'crypto', 'GLOBAL', 'binance', 'CRYPTO', 'Solana', 32),
