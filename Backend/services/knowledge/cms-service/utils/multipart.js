 ...
 *
 * Buffers the whole request body (fine for dev-scale uploads) and splits it on the
 * MIME boundary, binary-safe. Handles file parts (name + filename + Content-Type)
 * and plain text fields. Avoids pulling in multer/busboy, which aren't available
 * to this service in the workspace.
 */
