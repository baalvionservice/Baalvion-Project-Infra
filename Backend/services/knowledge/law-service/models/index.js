...
db.State        = require('./states')(sequelize, Sequelize.DataTypes);
db.City         = require('./cities')(sequelize, Sequelize.DataTypes);
db.PracticeArea = require('./practiceAreas')(sequelize, Sequelize.DataTypes);
db.LawyerPracticeArea = require('./lawyerPracticeAreas')(sequelize, Sequelize.DataTypes);
db.VerificationDocument = require('./verificationDocuments')(sequelize, Sequelize.DataTypes);
...
db.CaseNote     = require('./caseNotes')(sequelize, Sequelize.DataTypes);
db.CaseTask     = require('./caseTasks')(sequelize, Sequelize.DataTypes);
db.CaseTimeLog  = require('./caseTimeLogs')(sequelize, Sequelize.DataTypes);
...
db.LawyerConnection  = require('./lawyerConnections')(sequelize, Sequelize.DataTypes);
db.DiscussionGroup   = require('./discussionGroups')(sequelize, Sequelize.DataTypes);
