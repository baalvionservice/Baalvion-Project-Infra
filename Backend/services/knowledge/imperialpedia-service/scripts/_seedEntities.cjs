...
const company = (slug, name, industry, country, founded_year, headquarters, employees, website, technologies, competitors, category, description, tags, ticker = null) =>
  ({ slug, name, industry, country, category, description, tags, founded_year, headquarters, employees, website, technologies, competitors, ticker,
...
const DATA = {
  company: [
    company('nvidia', 'NVIDIA', 'semiconductors', 'united-states', 1993, 'Santa Clara, CA', 29600, 'https://nvidia.com', ['generative-ai', 'graphics-processing', 'machine-learning'], ['amd', 'intel'], 'Technology', 'Global leader in accelerated computing and the GPUs powering the AI revolution.', ['AI', 'chips', 'growth'], 'NVDA'),
    company('amd', 'AMD', 'semiconductors', 'united-states', 1969, 'Santa Clara, CA', 26000, 'https://amd.com', ['graphics-processing', 'machine-learning'], ['nvidia', 'intel'], 'Technology', 'Designer of high-performance CPUs and GPUs for data center, gaming, and AI.', ['chips', 'cpu', 'gpu'], 'AMD'),
    company('intel', 'Intel', 'semiconductors', 'united-states', 1968, 'Santa Clara, CA', 124800, 'https://intel.com', ['graphics-processing'], ['nvidia', 'amd', 'tsmc'], 'Technology', 'One of the world’s largest semiconductor manufacturers and x86 pioneer.', ['chips', 'foundry', 'legacy'], 'INTC'),
    company('tsmc', 'TSMC', 'semiconductors', 'taiwan', 1987, 'Hsinchu, Taiwan', 76000, 'https://tsmc.com', ['graphics-processing'], ['intel', 'samsung'], 'Technology', 'The world’s largest dedicated semiconductor foundry, fabricating most advanced chips.', ['foundry', 'chips', 'supply-chain'], 'TSM'),
    company('apple', 'Apple', 'consumer-electronics', 'united-states', 1976, 'Cupertino, CA', 161000, 'https://apple.com', ['machine-learning'], ['microsoft', 'alphabet'], 'Technology', 'Designs consumer hardware, software, and services around a tightly integrated ecosystem.', ['hardware', 'ecosystem', 'brand'], 'AAPL'),
    company('microsoft', 'Microsoft', 'cloud-computing', 'united-states', 1975, 'Redmond, WA', 221000, 'https://microsoft.com', ['cloud-computing', 'generative-ai'], ['alphabet', 'amazon'], 'Technology', 'Enterprise software, the Azure cloud, and a leading investor in generative AI.', ['cloud', 'ai', 'enterprise'], 'MSFT'),
    company('alphabet', 'Alphabet', 'internet', 'united-states', 1998, 'Mountain View, CA', 182000, 'https://abc.xyz', ['machine-learning', 'cloud-computing', 'generative-ai'], ['microsoft', 'amazon'], 'Technology', 'Parent of Google — search, advertising, Android, and Google Cloud.', ['search', 'ads', 'ai'], 'GOOGL'),
    company('amazon', 'Amazon', 'e-commerce', 'united-states', 1994, 'Seattle, WA', 1525000, 'https://amazon.com', ['cloud-computing', 'machine-learning'], ['microsoft', 'alphabet'], 'Technology', 'Global e-commerce and the dominant cloud provider via AWS.', ['cloud', 'retail', 'logistics'], 'AMZN'),
    company('tesla', 'Tesla', 'electric-vehicles', 'united-states', 2003, 'Austin, TX', 140000, 'https://tesla.com', ['lithium-ion-battery', 'machine-learning'], ['byd', 'volkswagen'], 'Automotive', 'Electric vehicles, energy storage, and an aggressive bet on autonomy.', ['ev', 'energy', 'autonomy'], 'TSLA'),
    company('openai', 'OpenAI', 'artificial-intelligence', 'united-states', 2015, 'San Francisco, CA', 1700, 'https://openai.com', ['generative-ai', 'machine-learning'], ['alphabet', 'anthropic'], 'Technology', 'AI research lab behind GPT and a defining force in generative AI.', ['ai', 'research', 'llm']), // privately held — no ticker
    company('meta', 'Meta', 'internet', 'united-states', 2004, 'Menlo Park, CA', 74000, 'https://meta.com', ['generative-ai', 'machine-learning'], ['alphabet'], 'Technology', 'Operates Facebook, Instagram, and WhatsApp, and develops VR/AR hardware through Reality Labs.', ['social', 'ads', 'vr'], 'META'),
    company('berkshire-hathaway', 'Berkshire Hathaway', 'insurance', 'united-states', 1839, 'Omaha, NE', 396000, 'https://berkshirehathaway.com', [], [], 'Financials', 'Diversified holding company spanning insurance, railroads, and energy, with a large public-equity portfolio.', ['value', 'insurance', 'holding-company'], 'BRKB'),
  ],
  country: [
